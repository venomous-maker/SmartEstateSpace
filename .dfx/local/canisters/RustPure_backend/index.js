...
import { idlFactory } from './RustPure_backend.did.js';
export { idlFactory } from './RustPure_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RUSTPURE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./RustPure_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the RustPure_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./RustPure_backend.did.js")._SERVICE>}
 */
export const RustPure_backend = createActor(canisterId);
